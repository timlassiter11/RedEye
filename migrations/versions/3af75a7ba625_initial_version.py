...
Revision ID: 3af75a7ba625
Revises: 
Create Date: 2022-07-26 08:55:25.944966
...
def upgrade():
    ...
    sa.Column('confirmation_number', sa.String(length=6), nullable=False),
    sa.Column('departure_id', sa.Integer(), nullable=True),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('email', 'confirmation_number', name='_pnr')
    )
